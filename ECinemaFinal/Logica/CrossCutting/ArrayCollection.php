<?php
// http://www.doctrine-project.org/api/common/2.1/source-class-Doctrine.Common.Collections.ArrayCollection.html#ArrayCollection
namespace ECinema\CrossCutting {
	include_once ('CrossCutting/ICollections.php');
	//use ECinema\CrossCutting\Collection;
